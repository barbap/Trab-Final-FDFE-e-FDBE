...
-->
	...
	<link rel="stylesheet" href="{{ asset('css/app/templatemo-blue.css') }}">
</head>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<img src="{{ asset('images/app/tm-easy-profile.jpg') }}" class="img-responsive img-circle tm-border" alt="templatemo easy profile">
				<hr>
...
<script src="{{ asset('js/app/jquery.backstretch.min.js') }}"></script>
